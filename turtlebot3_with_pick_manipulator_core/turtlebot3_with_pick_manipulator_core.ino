...
void goalGripperPositionCallback(const sensor_msgs::JointState& goal_gripper_position_msg)
{
  ...
  nh.loginfo("recieve goalGripperPositionCallback ");
...
void updateJointStates(void)
{
  ...
  joint_states_pos[5] = joint_states_pos[6];
  ...
  joint_states_vel[5] = joint_states_vel[6];
...
void initJointStates(void)
{
  ...
  static char *joint_states_name[] = {"joint1", "joint2", "joint3", "joint4", "grip_joint", "grip_joint_sub"};
  ...
  joint_states.name_length     = JOINT_NUM + PALM_NUM;
  joint_states.position_length = JOINT_NUM + PALM_NUM;
  joint_states.velocity_length = JOINT_NUM + PALM_NUM;
  joint_states.effort_length   = JOINT_NUM + PALM_NUM;
}
