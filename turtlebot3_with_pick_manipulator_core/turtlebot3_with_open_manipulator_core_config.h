...
ros::Subscriber<sensor_msgs::JointState> joint_position_sub("open_manipulator/goal_joint_position", goalJointPositionCallback);
...
ros::Subscriber<sensor_msgs::JointState> gripper_position_sub("open_manipulator/goal_gripper_position", goalGripperPositionCallback);
...
PickManipulatorMotorDriver joint_driver;
